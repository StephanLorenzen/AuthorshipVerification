...
def model(dinfo):
    ...
    pos_pool9 = L.GlobalMaxPooling1D(name='pos_pool9')
    ...
    for name in ['known', 'unknown']:
        ...
        p_out9 = pos_pool9(pos_conv9(pos_embd(p_in)))

        concat = L.concatenate([c_out4,w_out3,p_out3,p_out6,p_out9])
